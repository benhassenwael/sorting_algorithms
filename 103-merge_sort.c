...
/**
 * _merge_split - recursively called subroutine
 * to split array and merge after
 * @output: temporary array to store intermediate sorted subarrays
...
/**
 * copy_output_to_input - copy output to array
 * @array: input array
...
/**
 * merge_sort - recursive merge sort algorithm
 * using top down merge strategy
 * @array: array to sort
 * @size: size of array
 *
 */
